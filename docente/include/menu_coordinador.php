...
<div class="col-md-3 left_col menu_fixed">
  <div class="left_col scroll-view">
    ...
    $res_pe = buscarCarrerasById($conexion, $res_b_u_sesion['id_programa_estudio']);
    $prog_es = mysqli_fetch_array($res_pe);
    ...
    <div class="profile clearfix">
      ...
      <div class="">
        ...
        <div>
          ...
          <h5 class="cargo">Coordinador de <?php echo $prog_es['nombre'] ?></h5>
        </div>
      </center>
    </div>
    <!-- /menu profile quick info -->
