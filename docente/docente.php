        ...
        <div class="right_col main" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-8 col-sm-7 col-xs-12">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 tile_stats_count blur">
                <span class="count_top green"><i class="fa fa-pencil-square-o"></i> Mis Unidades Didácticas</span>
                <div class="count"><?php echo $cont_prog; ?></div>
                <span class="count_bottom"><a href="calificaciones_unidades_didacticas.php"><i class="green"><i class="fa fa-arrow-circle-right"></i> Ver detalles</i></a></span>
              </div>
            </div>
