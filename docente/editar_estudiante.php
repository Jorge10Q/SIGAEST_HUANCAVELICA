                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <form role="form" action="operaciones/actualizar_estudiante.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="egresado" value="<?php echo $res_busc_est['egresado']; ?>">
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Dni : </label>
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <input  <?php echo $condicion; ?> type="number" class="form-control" name="dni" required="" maxlength="8" value="<?php echo $res_busc_est['dni']; ?>">
                            <br>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <input  <?php echo $condicion; ?> type="text" class="form-control" name="ap_nom" required="" value="<?php echo $res_busc_est['apellidos_nombres']; ?>">
                            <br>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <select  <?php echo $condicion; ?> class="form-control" id="carrera" name="carrera" value="<?php echo $res_busc_est['id_programa_estudios']; ?>" required="required">
                              <option></option>
                              <?php
