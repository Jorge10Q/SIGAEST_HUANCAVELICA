          ...
          <!-- Contenido de la página -->
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="x_panel">
                      <div class="x_title">
                          <h2>Conteo de postulantes por empresas</h2>
                          <div class="clearfix"></div>
                      </div>
                      <div class="x_content">
                          <p>Reporte de empresas con mayores postulantes a convocatorias que hayan finalizado en el rango de fechas seleccionadas.</p>
                          <button  onclick="generarReporte('Conteo de postulantes por empresas')" class="btn btn-primary">Generar Reporte</button>
                      </div>
                  </div>
              </div>
  ...
  <script>
    ...
    <script>
        $(function() {
          ...
          // Restaurar el rango de fechas si está almacenado en localStorage
          var savedDateRange = localStorage.getItem('savedDateRange');
          if (savedDateRange) {
            $('#reservation').val(savedDateRange);
          }
        
          // Guardar el rango de fechas en localStorage cuando se selecciona uno
          $('#reservation').on('change', function() {
                localStorage.setItem('savedDateRange', $(this).val());
            });
        });
    </script>
