                    ...
                    <table id="tabla-estudiantes" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th
                          <?php if($mostrar_menu){ ?>
                            width="22%" <?php } ?> width="16%" >Acciones</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php 
                        ...
                        <tr>
                          ...
                          <td>
                          <a class="btn btn-success" href="editar_estudiante.php?id=<?php echo $res_busc_est['id']; ?>" data-toggle="tooltip" data-original-title="Editar" data-placement="bottom" ><i class="fa fa-pencil-square-o"></i></a>
                          ...
                          <a class="btn btn-dark" href="informacion_socioeconomica.php?id=<?php echo $res_busc_est['id']; ?>" data-toggle="tooltip" data-original-title="Información Socioeconómica" data-placement="bottom"><i class="fa fa-info"></i></a>
                          <?php if($mostrar_menu){ ?>
