...
?>
    ...
    <head>
        ...
        <title>Empresas <?php include("../include/header_title.php"); ?></title>
        <!--icono en el titulo-->
                                                    ...
                                                    <div id="wizard">
                                                        ...
                                                        <section>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="ruc" name="ruc" oninput="validateInputNum(this,11)">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-form-label label-align" for="logo">Logo con el nombre de la empresa:</label>
                                                                <div class="">
                                                                    <div class="container-input">
                                                                        <input type="file" name="logo" id="file-3" class="inputfile inputfile-3" accept=".png, .jpeg, .jpg" />
                                                                        <label for="file-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control" id="correo" name="correo" onkeyup="javascript:this.value=this.value.toLowerCase();">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="celular">Teléfono - Celular:</label>
                                                                <input type="text" class="form-control" id="celular" name="celular" oninput="validateInputNum(this,9)">
                                                            </div>
                                                        </section>
