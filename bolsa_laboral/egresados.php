                    ...
                    <table id="tabla-egresados" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th>Programa</th>
                          <th>Plan</th>
                          <th <?php if ($mostrar_menu) { ?> width="22%" <?php } ?> width="16%">Acciones</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                        ...
                        while ($res_busc_est = mysqli_fetch_array($ejec_busc_est)) {
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a class="btn btn-primary" href="documentos_egresado.php?id=<?php echo $res_busc_est['id']; ?>"
                                data-toggle="tooltip" data-original-title="Documentos Egresado" data-placement="bottom"><i
                                  class="fa fa-folder-open"></i></a>
                              <?php if ($mostrar_menu) { ?>
                                <button class="btn btn-primary" data-toggle="modal"
                                  data-target=".edit_password<?php echo $res_busc_est['id']; ?>"><a data-toggle="tooltip"
                                    data-original-title="Cambiar contraseña" data-placement="bottom"><i class="fa fa-key"
                                      style="color: white"></i></a></button>
                                <button class="btn btn-danger" data-toggle="modal"
                                  data-target=".delete_user<?php echo $res_busc_est['id']; ?>"><a data-toggle="tooltip"
