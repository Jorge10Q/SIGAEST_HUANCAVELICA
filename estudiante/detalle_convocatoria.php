                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="list-unstyled project_files">
                                    <li><strong>Razón Social: </strong> <br> <?php echo $convocatoria['empresa']?>
                                    </li>
                                    ...
                                    <li><strong>Inicio de Convocatoria: </strong> <br> <?php echo convertirFormatoFecha($convocatoria['fecha_inicio']) ?>
                                    </li>
                                    <li><strong>Fin de Convocatoria: </strong> <br> <?php echo convertirFormatoFecha($convocatoria['fecha_fin']) ?>
                                    </li>
                                ...
                                <ul class="list-unstyled project_files">
                                    <?php 
                                        ...
                                        $cantidad_doc = mysqli_num_rows($res);
                                        if($cantidad_doc == 0){
                            ...
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    ?> 
                                     ...
                                     <form role="form" action="operaciones/registrar_postulacion.php" class="form-horizontal form-label-left input_mask" method="POST">
                                        <input type="hidden" name="id" value="<?php echo $r_b_estudiante['id']; ?>">
                                        <input type="hidden" name="tipo" value="<?php echo 0; ?>">
                                        <input type="hidden" name="dni" value="<?php echo $r_b_estudiante['dni']; ?>">
                                        <input type="hidden" name="nombre" value="<?php echo $r_b_estudiante['apellidos_nombres']; ?>">
                                        <input type="hidden" name="dirección" value="<?php echo $r_b_estudiante['direccion']; ?>">
                                        <input type="hidden" name="correo" value="<?php echo $r_b_estudiante['correo']; ?>">
                                        <input type="hidden" name="celular" value="<?php echo $r_b_estudiante['telefono']; ?>">
                                        <input type="hidden" name="convocatoria" value="<?php echo $convocatoria['id']; ?>">
                                        <button type="submit" class="btn btn-sm btn-primary">Quiero Postular</button>
                                    </form>
                                    <?php } ?>
                                </div>
                            </div>
